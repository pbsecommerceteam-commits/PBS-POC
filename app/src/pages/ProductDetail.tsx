...
export default function ProductDetail() {
  ...
  const facts = [
    ...
    { label: "Price index", value: p.priceIndex != null ? (p.priceIndex * 100).toFixed(0) : "—", sub: p.priceIndex != null ? "$" + p.price.toFixed(2) + " current price" : "No matched competitor listing" },
